...
import { CreditsView, EpisodeView, ErrorView, GenreView, HomeView, MovieView, MoviesView, PersonView, ReviewsView, SearchView, SeasonsView, TelevisionView, TrailersView, TrendingView } from '@/views';
