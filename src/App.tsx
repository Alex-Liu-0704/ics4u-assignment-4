...
import { CreditsView, EpisodeView, ErrorView, GenreView, HomeView, MovieView, MoviesView, ReviewsView, SearchView, SeasonsView, TelevisionView, TrailersView, TrendingView } from '@/views';
